...
@app.route("/suggestions1")
def suggestions1():
	return render_template("suggestions1.html")

@app.route("/suggestions2")
def suggestions2():
	return render_template("suggestions2.html")

@app.route("/suggestions3")
def suggestions3():
	return render_template("suggestions3.html")

@app.route("/suggestions4")
def suggestions4():
	return render_template("suggestions4.html")
...
def profile_and_predict():
	...
	if arr_results[0]==0:
		...
		treatment_likelihood="1"
	elif arr_results[0]==2:
		treatment_likelihood="2"
	elif arr_results[0]==3:
		treatment_likelihood="3"
	elif arr_results[0]==4:
		treatment_likelihood="4"
...
def create_model():
	...
	y_test1=y_test.copy()
	for ind in y_test1.index:
		if(y_test1[ind] in [1,2,3,4]):
			y_test1[ind]=1
	# feature importance
	...
	def evalClassModel(model, y_test1, y_pred_class):
		...
		classification_accuracy=metrics.accuracy_score(y_test1, y_pred_class)
		classification_error=1-classification_accuracy
		print("Classification Accuracy:", classification_accuracy)
		print("Classification Error:", classification_error)

		false_positive_rate = FP/float(TN + FP)
		precision=metrics.precision_score(y_test1, y_pred_class)
		auc_score=metrics.roc_auc_score(y_test1, y_pred_class)
	...
	def logisticRegression():
		...
		for i in range(len(y_pred_class)):
			if(y_pred_class[i] in [1,2,3,4]):
  				y_pred_class[i]=1
		print("\n########### Logistic Regression ###############")
		score_arr=evalClassModel(logreg, y_test1, y_pred_class)
	...
	def Knn():
		...
		score_arr = evalClassModel(knn, y_test1, y_pred_class)
		accuracy_score=score_arr[0]
	...
	def treeClassifier():
		...
		print("\n########### Tree classifier ###############")
		score_arr=evalClassModel(tree, y_test1, y_pred_class)
		accuracy_score=score_arr[0]
	...
	def randomForest():
		...
		print("\n########### Random Forests ###############")
		score_arr=evalClassModel(my_forest, y_test1, y_pred_class)
		accuracy_score=score_arr[0]
	...
	def bagging():
		...
		for i in range(len(y_pred_class)):
			if(y_pred_class[i] in [1,2,3,4]):
  				y_pred_class[i]=1
		print("\n########### Bagging ###############")
		score_arr=evalClassModel(bag, y_test1, y_pred_class)
		accuracy_score=score_arr[0]
	...
	def boosting():
		...
		for i in range(len(y_pred_class)):
			if(y_pred_class[i] in [1,2,3,4]):
  				y_pred_class[i]=1
		print("\n########### Boosting ###############")
		score_arr=evalClassModel(boost, y_test1, y_pred_class)
		accuracy_score=score_arr[0]
	...
	def stacking():
		...
		for i in range(len(y_pred_class)):
			if(y_pred_class[i] in [1,2,3,4]):
  				y_pred_class[i]=1
		print("\n########### Stacking ###############")
		score_arr = evalClassModel(stack, y_test1, y_pred_class)
		accuracy_score=score_arr[0]
